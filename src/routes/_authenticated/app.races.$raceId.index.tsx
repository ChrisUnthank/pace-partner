          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              {/* Split pace — overall (above) can blend warmup/cooldown/work
                  ...
                  RPE lives here too — a subjective effort rating reads more
                  naturally alongside the pace breakdown than as a fourth
                  "hard number" stat next to Time/Distance/Pace. */}
